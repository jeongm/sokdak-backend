...
<img width="1562" height="488" alt="Image" src="https://github.com/user-attachments/assets/32c50903-a2fc-45cf-af52-73833a499321" />
사용자의 감정을 분석하고, 감정에 어울리는 캐릭터가 대화 상대가 되어주는 감정 기반 챗봇 어플리케이션

## 📝 프로젝트 소개
- 조명과 연동되어 사용자의 감정에 도움이 되는 정서공감형 
